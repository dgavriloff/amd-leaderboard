...
const themes = {
  light: {
    ...
    footerText: "rgba(0,0,0,0.7)",
    footerTextHover: "rgba(0,0,0,0.9)",
    fallbackBg: "#e8e8e8",
  },
  dark: {
                ...
                {problemConfigs.map((p) => {
                  ...
                  return (
                    <div key={p.name}>
                      ...
                      <div style={{ display: "flex", alignItems: "baseline", gap: 8, fontVariantNumeric: "tabular-nums", visibility: detail ? "visible" : "hidden" }}>
